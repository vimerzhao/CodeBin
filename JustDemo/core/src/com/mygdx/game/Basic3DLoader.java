...
public class Basic3DLoader extends ApplicationAdapter implements InputProcessor {
    ...
    public void create() {
        ...
        model = modelLoader.loadModel(Gdx.files.getFileHandle("knight.g3db", Files.FileType.Internal));
        ...
        controller.setAnimation("Attack", -1, new AnimationController.AnimationListener() {
            @Override
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        if (!isFirstClick) {
            if (System.currentTimeMillis() -curtime < 500) {
                if (isRunning) {
                    controller.setAnimation("Attack", 0);
                } else {
